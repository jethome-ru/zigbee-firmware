...
## Версии прошивок
  ...
  * ws7_20231217_f123_f001_0000000d - исправлено отображение состояния батареи после OTA обновления.
  
## Инструкция по обновлению устройства с помощью механизма OTA

Устройства JetHome WS7 поддерживают механизм обновления OTA в Zigbee2MQTT начиная с версии 1.34.0. Для выполнения обновления на версиях от 1.34.0, выполните Инструкцию ниже пропустив первые два пункта.
